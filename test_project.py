...
class TestProjectFunctions:
    ...
    @patch('builtins.input', side_effect=["John Doe", "1234567890", "email@mbu.asia", "9876543210", "3", "CSE"])
    
    def test_registration_form(self, mock_input):
        registration_details = project.registration_form("1", "Sports")
        assert registration_details == ("1234567890", "John Doe", "9876543210", "email@mbu.asia", "3", "CSE")
    ...
    def test_event_pass(self, mock_qrcode_make, mock_fpdf):
        ...
        event_name = "Sports"
        project.event_pass(student_id, student_name, student_phone, student_email, event_name)
